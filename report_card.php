...
<body>
    ...
    $query = $sql->Prepare("Select *,tbl_class_members.class as stage from tbl_student,tbl_classes,tbl_class_members where tbl_student.ID='$studentData'  and tbl_class_members.student=tbl_student.indexno and tbl_classes.name=tbl_student.class and tbl_class_members.year='$thisyear' and tbl_class_members.term='$thisterm' ");
    // print_r($query);
    ...
    <center><table id="transcript" class='table table-vmiddle'>
		...
		$stmt22=$sql->Prepare("select * from tbl_assesments,tbl_courses,tbl_subjects where tbl_assesments.stuId='$studentData' and tbl_assesments.year='$yearData' and tbl_assesments.term='$termData' and tbl_assesments.courseId=tbl_courses.id and tbl_subjects.name=tbl_courses.name and tbl_subjects.type='core' order by tbl_subjects.type ASC,tbl_subjects.name ASC");
     ...
     <?php 
		...
		$stmt2=$sql->Prepare("select * from tbl_assesments,tbl_courses,tbl_subjects where tbl_assesments.stuId='$studentData' and tbl_assesments.year='$yearData' and tbl_assesments.term='$termData' and tbl_assesments.courseId=tbl_courses.id and tbl_subjects.name=tbl_courses.name and tbl_subjects.type='elective' order by tbl_subjects.type ASC,tbl_subjects.name ASC");
...
<table width="92%" style=" " height="496" border="0" align="center">
      ...
      <tr>
        <td width="291" height="47"><div align="left"><span class="rp">ATTENDANCE</span>:
		 ...
		 $queryData=$sql->Prepare("select * from tbl_class_members where student='$studentNo' and year='$yearData' and term='$termData'");
               //  print_r($queryData);
                 $stmtData=$sql->Execute($queryData);
                $t=$stmt->RecordCount();
            while($r =$stmtData->FetchRow())
