...
ini_set('display_errors', 0);
    ...
    if ($extension == 'csv') {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
            ...
            $query = $sql->Prepare("UPDATE tbl_student SET GENDER ='" . $col2 . "', HOUSE ='" . $col3 . "', GUARDIAN_PHONE ='" . $col4 . "'  WHERE INDEXNO='" . $col1 . "'");
            print_r($query);
            $a = $sql->Execute($query);
...
?>
    <div class="card-body card-padding">
        <form action="studentupdate.php?upload=biodata" role="form" method="POST" enctype="multipart/form-data">
