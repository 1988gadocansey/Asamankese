               ...
               <div class="section-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <p class="text-caption">WAEC PRINTOUT</p>
                        </div>
                        <div align="center"><p class="text-bolder text-success">Class List of <?PHP  echo $class?></p></div>
                        <hr>                       
 <?php
