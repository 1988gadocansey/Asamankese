                        ...
                        <div class="card-header">
                           <p>
                            ...
                            <div style="margin-top:-3%;float:right">
                                ...
                                <a href="students.php" title="add a student" class="btn bgm-orange waves-effect"> Add Student<i class="md md-add"></i></a>
            ...
            <table  width="%" border="0">
               ...
               <?php }?>
                    ...
                    <td width="20%">
                     ...
                     <select  class='form-control' name='gender'       style="margin-left:46%">
...
<p>&nbsp;</p>
            ...
            <table id="students" class="table table-bordered  table-vmiddle" >
