               ...
               <div class="section-body">
                     <div class="card">
                        <div class="card-header">
                            <h2>Assign Courses to Classes  </h2>
                        </div>
                        
                        <div class="card-body card-padding">
                            <form action="assign_courses.php" method="POST" class="form-horizontal" role="form">
                                                 <div class="card-body card-padding">
                                                     ...
                                                     <div class="form-group">
                                                         <label for="inputPassword3" class="col-sm-2 control-label">Select Subject</label>
                                                         <div class="col-sm-10">
