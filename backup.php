...
****************************************************/
	$db_server			= 'localhost';				// Database server, usually "localhost", 
 	...
 	$db_name 			= 'phylio_school_management_system';				// Database name, leave empty for 'all databases'
	$db_user 		    = 'root';				// Database username
	$db_pass 		    = 'PRINT45dull';				// Database password
...
/***************************************************
	E-mail settings
****************************************************/
 	$website            = 'naraguta.edu.gh';		    // Your site's domain (without www. part)
	$send_to 		    = 'gadocansey@gmail.com';		        // backup file will be sent to?
	$from 		        = 'Naraguta' . $website;	// some hosting providers won’t let you send backups from invalid e-mail address
...
****************************************************/
    ...
    $full_path      = 'D:/xampp/htdocs/Naraguta-Academy'; 
